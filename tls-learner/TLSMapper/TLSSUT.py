...
class TLS13SUT(LTLfSUT):
    ...
    def load_key_and_cert(self, keyfile, certfile):
        if keyfile is None or certfile is None:
            ...
            self.cert_chain = Nonekey_log_write
            return 
        try:
    ...
    def reset(self):
        ...
        # # for wireshark decrypt
        self.TLS_client.key_log_write = True
        self.TLS_client.key_log_file='./key_log.file'
        #for boringSSL
        # self.TLS_client.pre_set_extensions=[[(3,4),(3,3)],[GroupName.x25519,GroupName.secp256r1],[(6,1),(5,1),(4,1),(6,3),(5,3),(4,3)]] # [versions,groups,sig_algs]
        # self.TLS_client.pre_set_extensions=[[(3,4)],None,None]
    ...
    def process_query(self, letter):
        ...
        # print(response)
        if response in ['UnSupported', 'SendFailed', 'SigFailed', 'NoClientCert','NeSessionBefore']:
            return 'None'
        return response
