...
class TLS10SUT(LTLfSUT):
    ...
    def reset(self):
        ...
        self.TLS_client = TLSClient10(sock, ciphersuites=self.ciphersuites, privateKey=self.privateKey, cert_chain=self.cert_chain)
