...
class TLSConnection(TLSRecordLayer):
    ...
    def _handshakeClientAsyncHelper(self, srpParams, certParams, anonParams,
        ...
        # print("gjhghjjhgjhgjhg",nextProto, serverHello.getExtension(ExtensionType.encrypt_then_mac),serverHello.getExtension(ExtensionType.extended_master_secret))
        ...
        # print("priv",privateKey,"clientCertChain",clientCertChain)
        ...
        # print("gbjhgjghjhgjhg",settings.cipherImplementations,nextProto, settings)
    ...
    def _clientKeyExchange(self, settings, cipherSuite,
        ...
        try:
            ...
            premasterSecret = keyExchange.processServerKeyExchange(publicKey,
                                                                   ske)
            print(",publicKey,premasterSecret",publicKey,premasterSecret)
    ...
    def _clientFinished(self, premasterSecret, clientRandom, serverRandom,
        ...
        if self.extendedMasterSecret:
            ...
            masterSecret = calc_key(self.version, premasterSecret,
                                    ...
                                    output_length=48)
        print("fewbiufewgbifu",cipherImplementations,nextProto)
        self._calcPendingStates(cipherSuite, masterSecret, 
                                clientRandom, serverRandom, 
                                cipherImplementations)
        print("asdbgisgdi",self._recordLayer._writeState.encContext)
        #Exchange ChangeCipherSpec and Finished messages
...
#pylint: enable = undefined-loop-variable
    ...
    def _sendFinished(self, masterSecret, cipherSuite=None, nextProto=None,
        ...
        # print("_handshake_hash",self._handshake_hash)
        # print("hhshshhshs",dir(self._handshake_hash))
