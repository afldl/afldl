...
def test_fuzz_ClientHello():
    ciphersuites=[CipherSuite.TLS_AES_128_GCM_SHA256,
                    CipherSuite.TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256]
    # alphabet = ['ClientHello', 'ChangeCipherSpec', 'Finish', 'ApplicationData','TLS13ReClientHello']
    # alphabet = ['ClientHelloEmtyKeyShare']
    # alphabet = ['ClientHelloEmtyKeyShare', 'ClientHello']
    alphabet = ['ClientHelloEmtyKeyShare', 'ClientHello', 'ChangeCipherSpec', 'Certificate',  'CertificateVerify', 'Finish', 'ApplicationData','ResumptionClientHello', 'Finish','KeyUpdate', 'ApplicationData']
    ...
    for i in range(100000):
        ...
        sul.fuzz_log = log
        # sul.fuzz_flag = False
        random_element = random.choice(alphabet)
        sul.fuzz_letter = [random_element]
        # sul.fuzz_letter = ['KeyUpdate']
        # print("\n")
        # print('fuzz letter:', random_element)
        sul.query(alphabet)
